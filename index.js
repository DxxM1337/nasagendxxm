...
bot.on("ready", () => {	
    ...
    bot.user.setGame('Bot on, /gen to generate - by DxxM')
});	
...
bot.on("message", async message => {	
    ...
    if (command === "gen") {	
        if(message.channel.id !== "804327767301685278") return message.channel.send("This command can be runned only in the generate channel")	
